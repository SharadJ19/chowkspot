...
// Shared Brand Header with Full Logo SVG and Emerald Accent Bar
...
<body style="margin: 0; padding: 0; background-color: #f6f8fa; font-family: 'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #f6f8fa; padding: 40px 0;">
    <tr>
      <td align="center">
        <table role="presentation" width="100%" max-width="600px" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; border: 1px solid #e2e8f0; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(15, 23, 42, 0.05);">
          ...
          <tr>
            <td style="padding: 32px 40px 24px 40px; border-bottom: 1px solid #f1f5f9;">
              <table role="presentation" cellspacing="0" cellpadding="0">
                <tr>
                  <td>
                    <!-- ChowkSpot SVG Full Logo Wordmark Simulation -->
                    <span style="font-size: 26px; font-weight: 800; color: #0f172a; letter-spacing: -1px; text-decoration: none;">
...
export const sendVerificationEmail = async (
  ...
  const content = `
    ...
    <p style="color: #64748b; font-size: 13px; margin: 24px 0 0 0; border-top: 1px solid #f1f5f9; paddingTop: 16px;">
  ...
  const mailOptions = {
    ...
    html: getEmailWrapper('Verify Your ChowkSpot Account', content),
  };
...
export const sendPasswordResetEmail = async (
  ...
  const mailOptions = {
    ...
    html: getEmailWrapper('Reset Your ChowkSpot Password', content),
  };
